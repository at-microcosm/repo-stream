...
- custom deserialize for MST nodes that does as much depth calculation and key validation as possible in-line. (not clear if it actually made anything faster)
